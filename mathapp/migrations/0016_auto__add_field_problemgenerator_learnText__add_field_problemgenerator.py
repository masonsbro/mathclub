...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'mathapp.problemgenerator': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mathapp.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'learnText': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mathapp.LearnText']", 'null': 'True'}),
            'learnVideo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mathapp.LearnVideo']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
