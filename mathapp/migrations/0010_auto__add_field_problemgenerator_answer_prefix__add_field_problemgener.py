...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemGenerator.answer_prefix'
        db.add_column(u'mathapp_problemgenerator', 'answer_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'ProblemGenerator.answer_suffix'
        db.add_column(u'mathapp_problemgenerator', 'answer_suffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemGenerator.answer_prefix'
        db.delete_column(u'mathapp_problemgenerator', 'answer_prefix')

        # Deleting field 'ProblemGenerator.answer_suffix'
        db.delete_column(u'mathapp_problemgenerator', 'answer_suffix')
