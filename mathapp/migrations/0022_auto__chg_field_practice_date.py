...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.date'
        db.alter_column(u'mathapp_practice', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Practice.date'
        db.alter_column(u'mathapp_practice', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
