...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemGenerator.author'
        db.add_column(u'mathapp_problemgenerator', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mathapp.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemGenerator.author'
        db.delete_column(u'mathapp_problemgenerator', 'author_id')
