...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemGenerator.round'
        db.add_column(u'mathapp_problemgenerator', 'round',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemGenerator.round'
        db.delete_column(u'mathapp_problemgenerator', 'round')
