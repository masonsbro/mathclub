...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.user_answer'
        db.alter_column(u'mathapp_practice', 'user_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Practice.question'
        db.alter_column(u'mathapp_practice', 'question', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Practice.correct_answer'
        db.alter_column(u'mathapp_practice', 'correct_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

    def backwards(self, orm):

        # Changing field 'Practice.user_answer'
        db.alter_column(u'mathapp_practice', 'user_answer', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Practice.question'
        db.alter_column(u'mathapp_practice', 'question', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Practice.correct_answer'
        db.alter_column(u'mathapp_practice', 'correct_answer', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
